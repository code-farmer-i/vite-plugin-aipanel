import{F as e,G as t,H as n,I as r,M as i,P as a,k as o}from"./vue-libs-C0LO4NBv.js";import"./site-tciFcqcL.js";var s={class:`pagoda-doc-markdown-body`},c={id:`vite-cha-jian-pei-zhi`,tabindex:`-1`,class:`pagoda-doc-md-h1 pagoda-doc-md-title`},l={__name:`config`,setup(l,{expose:u}){return u({frontmatter:{}}),(l,u)=>{let d=t(`pagoda-doc-qrcode`);return n(),i(`div`,s,[o(`h1`,c,[u[0]||=e(`Vite 插件配置`,-1),r(d,{class:`pagoda-doc-md-qrcode`})]),u[1]||=o(`p`,{class:`pagoda-doc-md-p`},`Vite 插件负责启动 OpenCode Web 服务，是浏览器扩展正常工作所必需的。默认配置即可满足大多数场景，以下配置用于高级定制。`,-1),u[2]||=o(`h2`,{id:`an-zhuang`,tabindex:`-1`,class:`pagoda-doc-md-h2 pagoda-doc-md-title`},[o(`a`,{class:`header-anchor pagoda-doc-md-a`,href:`#an-zhuang`},`#`),e(` 安装`)],-1),u[3]||=o(`pre`,{class:`pagoda-doc-markdown-code-block-wrapper`},[o(`span`,{class:`pagoda-doc-markdown-code-block-lang`},`bash`),o(`code`,{class:`pagoda-doc-markdown-code-block language-bash`,"v-pre":``},`npm install -D vite-plugin-opencode-assistant
`)],-1),u[4]||=o(`h2`,{id:`zui-xiao-pei-zhi`,tabindex:`-1`,class:`pagoda-doc-md-h2 pagoda-doc-md-title`},[o(`a`,{class:`header-anchor pagoda-doc-md-a`,href:`#zui-xiao-pei-zhi`},`#`),e(` 最小配置`)],-1),u[5]||=o(`pre`,{class:`pagoda-doc-markdown-code-block-wrapper`},[o(`span`,{class:`pagoda-doc-markdown-code-block-lang`},`ts`),o(`code`,{class:`pagoda-doc-markdown-code-block language-ts`,"v-pre":``},[o(`span`,{class:`hljs-keyword`},`import`),e(` { defineConfig } `),o(`span`,{class:`hljs-keyword`},`from`),e(),o(`span`,{class:`hljs-string`},`"vite"`),e(`;
...
`)])],-1),u[6]||=o(`h2`,{id:`wan-zheng-pei-zhi`,tabindex:`-1`,class:`pagoda-doc-md-h2 pagoda-doc-md-title`},[o(`a`,{class:`header-anchor pagoda-doc-md-a`,href:`#wan-zheng-pei-zhi`},`#`),e(` 完整配置`)],-1),u[7]||=o(`pre`,{class:`pagoda-doc-markdown-code-block-wrapper`},[o(`span`,{class:`pagoda-doc-markdown-code-block-lang`},`ts`),o(`code`,{class:`pagoda-doc-markdown-code-block language-ts`,"v-pre":``},[o(`span`,{class:`hljs-keyword`},`import`),e(` opencodeAssistant `),o(`span`,{class:`hljs-keyword`},`from`),e(),o(`span`,{class:`hljs-string`},`"vite-plugin-opencode-assistant"`),e(`;
