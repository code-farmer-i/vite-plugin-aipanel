import{P as i,T as p,d as c,g,s,x as _}from"./vue.runtime.esm-bundler.CcdlJMSz.js";var u=`<svg t="1775402599580" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5390" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%">
  <defs>
...
`,d=g({__name:"OpenCodeLogo",props:{size:{type:[String,Number],required:!1,default:"100%"}},setup(t,{expose:r}){r();const e=t,o=p(),n=`opencode-logo-gradient-${o}`,a={props:e,baseId:o,gradientId:n,rendered:s(()=>u.replace('id="opencode-logo-gradient"',`id="${n}"`).replace(/url\(#opencode-logo-gradient\)/g,`url(#${n})`)),sizeStyle:s(()=>{const l=typeof e.size=="number"?`${e.size}px`:e.size;return{width:l,height:l}})};return Object.defineProperty(a,"__isScriptSetup",{enumerable:!1,value:!0}),a}}),f=["innerHTML"];function v(t,r,e,o,n,a){return _(),c("span",{class:"opencode-logo",style:i([{display:"inline-block",lineHeight:0},o.sizeStyle]),innerHTML:o.rendered},null,12,f)}d.render=v;var m=d,x=(t,r)=>{const e=t.__vccOpts||t;for(const[o,n]of r)e[o]=n;return e};export{m as n,x as t};
