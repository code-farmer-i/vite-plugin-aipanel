  ...
  <div class="home">
    ...
    <section class="hero">
      ...
      <div class="hero-inner">
        ...
        <h1 class="hero-title">
          <span class="line">让 <span class="grad">AI</span> 成为</span>
          <span class="line">你的开发搭档</span>
        </h1>
...
.hero-title .grad {
  background: linear-gradient(135deg, var(--purple) 0%, var(--indigo) 40%, #22d3ee 80%);
...
.download-icon {
  ...
  flex-shrink: 0;
  border-radius: 14px;
  background: linear-gradient(135deg, rgba(179, 154, 255, 0.2), rgba(129, 140, 241, 0.15));
  color: var(--purple);
